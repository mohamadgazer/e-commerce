...
//12
  ...
  static TextStyle s12Blackwhite = TextStyle(
    fontSize: 12.sp,
  ...
  //21
  static TextStyle s21BlackBlack = TextStyle(
    fontSize: 21.sp,
...
//12
  ...
  static TextStyle s12BookgreyDeeper = TextStyle(
    fontSize: 12.sp,
  ...
  static TextStyle s12BookGreenDeep = TextStyle(
    fontSize: 12.sp,
    color: AppColorManger.greenDeep,
    fontFamily: AppFont.book,
    fontWeight: FontWeight.normal,
  );
  ...
  //18
  static TextStyle s18BookGreenDeep = TextStyle(
    fontSize: 18.sp,
    color: AppColorManger.greenDeep,
    fontFamily: AppFont.book,
    fontWeight: FontWeight.normal,
